...
TrackType.create(id: 10, name: 'Поездка через АЗС')
TrackType.create(id: 11, name: 'Стоянка')
TrackType.create(id: 12, name: 'Исчерпан лимит стоянки')
TrackType.create(id: 12, name: 'Поездка в парк')
